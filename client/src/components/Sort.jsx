        ...
        <div className="flex items-center justify-center gap-1 md:gap-3 md:justify-start mx-auto md:mx-[80px] lg:mx-0">
            ...
            <Controller
              ...
              render={({ field }) => (
                ...
                >
                  <MenuItem className="bg-gray-100">Ninguno</MenuItem>
                  <MenuItem value={"lowtohigh"}>Menor a Mayor</MenuItem>

                  <MenuItem value={"hightolow"}>Mayor a Menor</MenuItem>
                </TextField>
              )}
            ></Controller>
            ...
            <Controller
              ...
              render={({ field }) => (
                ...
                >
                  <MenuItem className="bg-gray-100" >Ninguno</MenuItem>
                  <MenuItem value={"yearAscending"}>menor a mayor</MenuItem>

                  <MenuItem value={"yearDecending"}>mayor a menor</MenuItem>
                </TextField>
              )}
            ></Controller>
