...
const BookingsTable = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      headerName: "Ubicación de Recogida",
      width: 150,
    },
    { field: "Pickup_Date", headerName: "Fecha de Recogida", width: 150 },
    { field: "Dropoff_Location", headerName: "Ubicación de Devolución", width: 150 },
    {
      field: "Dropoff_Date",
    ...
    },
    {
      ...
      headerName: "Estado del Vehículo",
      width: 150,
      renderCell: (params) => (
